...
def _classify_channel(name: str, result: dict):
    ...
    streaming = {"PEACOCK","PARAMOUNT+","ESPN+","HULU","FUBO","FUBOTV","SLING","DIRECTV STREAM",
                 "MAX","APPLE TV+","AMAZON PRIME","AMAZON PRIME VIDEO","YOUTUBE TV","DAZN"}
